...
make_group(gp1,
    ...
    EXW(and, 1), EXW(sub, 1), EMPTY, EMPTY)//and, sub added 
...
make_group(gp5,
    EMPTY, EMPTY, EMPTY, EMPTY,
    EMPTY, EMPTY, EX(push), EMPTY)//pushl, added 
...
opcode_entry opcode_table [512] = {
  /* 0x00 */	EMPTY, IDEX(G2E, add), EMPTY, EMPTY,//add added
  ...
  /* 0x30 */	EMPTY, IDEX(G2E, xor), EMPTY, EMPTY,//xor added
  /* 0x34 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x38 */	EMPTY, EMPTY, EMPTY, IDEX(E2G, cmp),//cmp added
  /* 0x3c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x40 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x44 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x48 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x4c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x50 */	IDEX(r,push), IDEX(r,push), IDEX(r,push), IDEX(r,push),//push added 
  /* 0x54 */	IDEX(r,push), IDEX(r,push), IDEX(r,push), IDEX(r,push),
  /* 0x58 */	IDEX(r,pop), IDEX(r,pop), IDEX(r,pop), IDEX(r,pop), //push added 
  ...
  /* 0x74 */	IDEXW(J, jcc, 1), EMPTY, EMPTY, EMPTY,//je added 
  /* 0x78 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x7c */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x80 */	IDEXW(I2E, gp1, 1), IDEX(I2E, gp1), EMPTY, IDEX(SI2E, gp1),
  /* 0x84 */	EMPTY, IDEX(G2E, test), EMPTY, EMPTY,//test added 
  /* 0x88 */	IDEXW(mov_G2E, mov, 1), IDEX(mov_G2E, mov), IDEXW(mov_E2G, mov, 1), IDEX(mov_E2G, mov),
  /* 0x8c */	EMPTY, IDEX(E2G, lea), EMPTY, EMPTY,//lea added
  /* 0x90 */	EX(nop), EMPTY, EMPTY, EMPTY,//nop added 
  ...
  /* 0xc0 */	IDEXW(gp2_Ib2E, gp2, 1), IDEX(gp2_Ib2E, gp2), EMPTY, IDEX(I, ret),//ret added
  ...
  /* 0xe8 */	IDEX(I, call), EMPTY, EMPTY, EMPTY,//call added
  ...
  /* 0x94 */	IDEX(setcc_E, setcc), EMPTY, EMPTY, EMPTY,//sete added
  /* 0x98 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0x9c */	EMPTY, EMPTY, EMPTY, EMPTY,
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEX(E2G, movzx), EMPTY,//movzx added
